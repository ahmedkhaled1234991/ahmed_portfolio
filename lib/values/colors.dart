...
class AppColors {
  static const Color primaryColor = Color.fromARGB(255, 166, 84, 50);
  //Shades of primary color
  static const Color primary200 = Color.fromARGB(255, 168, 69, 39);
  ...
  //Blue
  static const Color brown300 = Color(0xFFA63E1C);
